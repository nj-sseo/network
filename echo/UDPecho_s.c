...
int main(int argc, char* argv[] ){
    ...
    while(1){
        ...
        sleep(1);
        msg_len = recvfrom(sd, buf, BUFF_SIZE, flag, (struct sockaddr*)&clnt_addr, &clnt_addr_size);
        fprintf(stdout, "Number of receptions: %d\n", num++);
        sendto(sd, buf, msg_len, flag, (struct sockaddr*)&clnt_addr, sizeof(clnt_addr));    
    }
